(function (global, factory) {
	...
	/*#__PURE__*/
	function (_Component) {
	  inheritsLoose(MapControl, _Component);
	...
	function (_MapControl) {
	  inheritsLoose(AttributionControl, _MapControl);
	...
	/*#__PURE__*/
	function (_Component) {
	  inheritsLoose(MapEvented, _Component);
	...
	function (_MapEvented) {
	  inheritsLoose(MapComponent, _MapEvented);
	...
	function (_MapComponent) {
	  inheritsLoose(MapLayer, _MapComponent);
	...
	function (_MapLayer) {
	  ...
	  function Path(props) {
	    ...
	    if (_this.contextValue == null) {
	      _this.contextValue = _extends_1({}, props.leaflet, {
	...
	function (_Path) {
	  ...
	  _proto.createLeafletElement = function createLeafletElement(props) {
	    var center = props.center,
	        radius = props.radius,
	        options = objectWithoutPropertiesLoose(props, ["center", "radius"]);
	...
	/*#__PURE__*/
	function (_Path) {
	  inheritsLoose(CircleMarker, _Path);
	  ...
	  _proto.createLeafletElement = function createLeafletElement(props) {
	    ...
	    this.contextValue = _extends_1({}, props.leaflet, {
	      popupContainer: el
	    });
	    return el;
	  };
	...
	/*#__PURE__*/
	function (_MapComponent) {
	  inheritsLoose(DivOverlay, _MapComponent);
	...
	/*#__PURE__*/
	function (_Path) {
	  inheritsLoose(FeatureGroup, _Path);
	...
	/*#__PURE__*/
	function (_MapLayer) {
	  inheritsLoose(GridLayer, _MapLayer);
	...
	/*#__PURE__*/
	function (_MapLayer) {
	  inheritsLoose(ImageOverlay, _MapLayer);
	...
	/*#__PURE__*/
	function (_MapLayer) {
	  inheritsLoose(LayerGroup, _MapLayer);
	...
	/*#__PURE__*/
	function (_Component) {
	  inheritsLoose(ControlledLayer, _Component);
	...
	function (_ControlledLayer) {
	  inheritsLoose(BaseLayer, _ControlledLayer);
	  ...
	  function BaseLayer(props) {
	    ...
	    _this2.contextValue = _extends_1({}, props.leaflet, {
	      layerContainer: {
	...
	function (_ControlledLayer2) {
	  inheritsLoose(Overlay, _ControlledLayer2);
	  ...
	  function Overlay(props) {
	    ...
	    _this3.contextValue = _extends_1({}, props.leaflet, {
	      layerContainer: {
	...
	/*#__PURE__*/
	function (_MapControl) {
	  inheritsLoose(LayersControl, _MapControl);
	  ...
	  _proto2.createLeafletElement = function createLeafletElement(props) {
	    var _children = props.children,
	        options = objectWithoutPropertiesLoose(props, ["children"]);
	...
	*/
	...
	var UniversalStyle = function (_Component) {
	  _inherits$1(UniversalStyle, _Component);

	  function UniversalStyle(props, context) {
	    _classCallCheck$1(this, UniversalStyle);

	    var _this = _possibleConstructorReturn$1(this, (UniversalStyle.__proto__ || Object.getPrototypeOf(UniversalStyle)).call(this, props, context));
	...
	var ClientStyle = function (_Component) {
	  _inherits$2(ClientStyle, _Component);

	  function ClientStyle(props, context) {
	    _classCallCheck$2(this, ClientStyle);

	    var _this = _possibleConstructorReturn$2(this, (ClientStyle.__proto__ || Object.getPrototypeOf(ClientStyle)).call(this, props, context));
	...
	function (_MapEvented) {
	  ...
	  _proto.componentDidMount = function componentDidMount() {
	    ...
	    var viewport = props.viewport,
	        options = objectWithoutPropertiesLoose(props, ["viewport"]);
	...
	/*#__PURE__*/
	function (_MapLayer) {
	  inheritsLoose(Marker, _MapLayer);
	...
	function (_Component) {
	  ...
	  function Pane() {
	    ...
	    defineProperty$1(assertThisInitialized(_this), "setStyle", function (_temp) {
	  ...
	  _proto.createPane = function createPane(props) {
	    ...
	    if (map != null && map.createPane != null) {
	      ...
	      this.setState({
	        name: name,
	        context: _extends_1({}, props.leaflet, {
	          pane: name
	        })
	      }, this.setStyle);
	    }
	...
	function (_DivOverlay) {
	  inheritsLoose(Popup, _DivOverlay);
	  ...
	  _proto.getOptions = function getOptions(props) {
	    return _extends_1({}, _DivOverlay.prototype.getOptions.call(this, props), {
	      autoPan: false
	    });
	  };
	...
	/*#__PURE__*/
	function (_MapControl) {
	  inheritsLoose(ScaleControl, _MapControl);
	...
	/*#__PURE__*/
	function (_GridLayer) {
	  inheritsLoose(TileLayer, _GridLayer);
	...
	/*#__PURE__*/
	function (_DivOverlay) {
	  inheritsLoose(Tooltip, _DivOverlay);
	...
	/*#__PURE__*/
	function (_MapLayer) {
	  inheritsLoose(VideoOverlay, _MapLayer);
	...
	/*#__PURE__*/
	function (_GridLayer) {
	  inheritsLoose(WMSTileLayer, _GridLayer);
	  ...
	  _proto.createLeafletElement = function createLeafletElement(props) {
	    var url = props.url,
	        params = objectWithoutPropertiesLoose(props, ["url"]);
	  ...
	  _proto.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
	    ...
	    var prevUrl = fromProps.url,
	        ...
	        prevParams = objectWithoutPropertiesLoose(fromProps, ["url", "opacity", "zIndex"]);

	    var url = toProps.url,
	        _o = toProps.opacity,
	        _z = toProps.zIndex,
	        params = objectWithoutPropertiesLoose(toProps, ["url", "opacity", "zIndex"]);
	...
	/*#__PURE__*/
	function (_MapControl) {
	  inheritsLoose(ZoomControl, _MapControl);
